...
module Kiik
  class CustomerTest < Test::Unit::TestCase
    ...
    should "create empty customer should raise exception" do
    ...
    should "create! empty customer should return invalid customer" do
      error = {type:"invalid_request_error", param:"name", message:"Param name is required"}
      make_customer({}, error)
    ...
    should "create should return a new customer with card" do
    ...
    should "create using instance should return customer" do
      data = {name:"Customer test", email:"customer@email.com", phone: "11223344", document:"11122233345"}
      make_customer data
